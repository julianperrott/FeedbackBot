namespace FeedbackBot.BotV1
{
    ...
    public class DialogFlow
    {
        ...
        public bool TextToIntent(string text, out Dictionary<string, object> parameters, out string intentName, out string speech)
        {
        ...
        public Dictionary<string, string> TextToResponses(string text, List<string> allowedIntents, List<DialogFlowEntityName> allowedEntities)
        {
            ...
            var success = this.TextToIntent(text, out parameters, out intentName, out speech);

namespace FeedbackBot.BotV1
{
    ...
    public class Bot
    {
        public const string DialogFlowAccessToken = "c58c79a33aeb43119f05599812bf3d1b ";
        ...
        private const string ParticipateIntent = "ParticipateIntent";
        ...
        {
            var result = dialogFlowMapper.TextToResponse(arg, ParticipateIntent, DialogFlowEntityName.YesNoEntity);
        ...
        {
            var allowedIntents = new List<string> { SpecialEventIntent, ParticipateIntent };
        ...
        private BotReponse RateExperienceState(BotState state, string arg)
        {
            ...
            return Say(state, BotStatus.RateExperience, "Oh dear I didn't understand you. Please could you rate your visit on a scale of poor, average, good or excellent ?");
        }
    }
}